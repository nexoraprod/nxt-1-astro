...
# Build image
docker build -t YOUR_DOCKERHUB_USERNAME/nxt-1-astro:latest .

# Push ke Docker Hub
docker push YOUR_DOCKERHUB_USERNAME/nxt-1-astro:latest
```
...
curl -O https://raw.githubusercontent.com/YOUR_USERNAME/nxt-1-astro/main/scripts/setup-server.sh
...
docker pull YOUR_DOCKERHUB_USERNAME/nxt-1-astro:latest
docker run -d -p 80:80 --name nxt-1-astro YOUR_DOCKERHUB_USERNAME/nxt-1-astro:latest
```
...
docker tag YOUR_DOCKERHUB_USERNAME/nxt-1-astro:v1.0.0 YOUR_DOCKERHUB_USERNAME/nxt-1-astro:latest

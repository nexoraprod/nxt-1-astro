...
# Connect ke GitHub
git remote add origin https://github.com/USERNAME/nxt-1-astro.git
git branch -M main
...
```bash
# Build image
docker build -t USERNAME/nxt-1-astro:latest .

# Tag dengan version
docker tag USERNAME/nxt-1-astro:latest USERNAME/nxt-1-astro:v1.0.0

# Push ke Docker Hub
docker push USERNAME/nxt-1-astro:latest
docker push USERNAME/nxt-1-astro:v1.0.0
```
...
```bash
# Build image
docker build -t ghcr.io/USERNAME/nxt-1-astro:latest .

# Push
docker push ghcr.io/USERNAME/nxt-1-astro:latest
```
...
services:
  app:
    image: USERNAME/nxt-1-astro:latest
...
```bash
# Clone repository
git clone https://github.com/USERNAME/nxt-1-astro.git
cd nxt-1-astro
...
```bash
# Tag image
docker tag nxt-1-astro:latest USERNAME/nxt-1-astro:latest
...
docker-compose down
docker tag USERNAME/nxt-1-astro:v1.0.0 USERNAME/nxt-1-astro:latest
docker-compose up -d
```
...
# Pull manual
docker pull USERNAME/nxt-1-astro:latest
```
